...
proc create_root_design { parentCell } {
  ...
  # Create instance: GUI_0, and set properties
  set GUI_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:GUI:1.0 GUI_0 ]
  ...
  connect_bd_net -net GUI_0_m_axis_tdata [get_bd_pins GUI_0/m_axis_tdata] [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tdata]
  connect_bd_net -net GUI_0_m_axis_tlast [get_bd_pins GUI_0/m_axis_tlast] [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tlast]
  connect_bd_net -net GUI_0_m_axis_tuser [get_bd_pins GUI_0/m_axis_tuser] [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tuser]
  connect_bd_net -net GUI_0_m_axis_tvalid [get_bd_pins GUI_0/m_axis_tvalid] [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tvalid]
  connect_bd_net -net GUI_0_s_axis_tready [get_bd_pins GUI_0/s_axis_tready] [get_bd_pins zoom_0/m_axis_tready]
  ...
  connect_bd_net -net btnD_1 [get_bd_ports btnD] [get_bd_pins zoom_0/btnD]
  connect_bd_net -net btnL_1 [get_bd_ports btnL] [get_bd_pins zoom_0/btnL]
  connect_bd_net -net btnR_1 [get_bd_ports btnR] [get_bd_pins zoom_0/btnR]
  connect_bd_net -net btnU_1 [get_bd_ports btnU] [get_bd_pins zoom_0/btnU]
  ...
  connect_bd_net -net mm_clk_150 [get_bd_pins AXI_BayerToRGB_1/StreamClk] [get_bd_pins AXI_GammaCorrection_0/StreamClk] [get_bd_pins GUI_0/aclk] [get_bd_pins MIPI_CSI_2_RX_0/video_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon_1/ACLK] [get_bd_pins axi_mem_intercon_1/M00_ACLK] [get_bd_pins axi_mem_intercon_1/S00_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins zoom_0/aclk]
  ...
  connect_bd_net -net sw_1_1 [get_bd_ports sw_1] [get_bd_pins zoom_0/sw_1]
  connect_bd_net -net v_axi4s_vid_out_0_locked [get_bd_pins rgb2dvi_0/aRst_n] [get_bd_pins v_axi4s_vid_out_0/locked]
  connect_bd_net -net v_axi4s_vid_out_0_s_axis_video_tready [get_bd_pins GUI_0/m_axis_tready] [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tready]
  ...
  connect_bd_net -net zoom_0_m_axis_tdata [get_bd_pins GUI_0/s_axis_tdata] [get_bd_pins zoom_0/m_axis_tdata]
  connect_bd_net -net zoom_0_m_axis_tlast [get_bd_pins GUI_0/s_axis_tlast] [get_bd_pins zoom_0/m_axis_tlast]
  connect_bd_net -net zoom_0_m_axis_tuser [get_bd_pins GUI_0/s_axis_tuser] [get_bd_pins zoom_0/m_axis_tuser]
  connect_bd_net -net zoom_0_m_axis_tvalid [get_bd_pins GUI_0/s_axis_tvalid] [get_bd_pins zoom_0/m_axis_tvalid]
  connect_bd_net -net zoom_0_s_axis_tready [get_bd_pins axi_vdma_0/m_axis_mm2s_tready] [get_bd_pins zoom_0/s_axis_tready]
  connect_bd_net -net zoom_0_x_cnt [get_bd_pins GUI_0/x] [get_bd_pins zoom_0/x_cnt]
  connect_bd_net -net zoom_0_y_cnt [get_bd_pins GUI_0/y] [get_bd_pins zoom_0/y_cnt]
