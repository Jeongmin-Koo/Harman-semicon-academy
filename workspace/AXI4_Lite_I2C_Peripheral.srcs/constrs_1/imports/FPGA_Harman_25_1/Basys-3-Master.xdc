...
# set_property -dict { PACKAGE_PIN V2    IOSTANDARD LVCMOS33 } [get_ports i2c_en]
# set_property -dict { PACKAGE_PIN T3    IOSTANDARD LVCMOS33 } [get_ports start]
# set_property -dict { PACKAGE_PIN T2    IOSTANDARD LVCMOS33 } [get_ports stop]
# set_property -dict { PACKAGE_PIN R3    IOSTANDARD LVCMOS33 } [get_ports wr_en]
