...
module stopwatch_data_path (
    ...
    //msec
    time_counter #(.TICK_COUNT(100), .BIT_WIDTH(7)) U_time_msec_counter (
        .clk(clk),
        .rst(rst),
        .tick(w_clk_100hz),
        .clear(clear),
    ...
    // sec
    time_counter #(.TICK_COUNT(60), .BIT_WIDTH(6)) U_time_sec_counter (
        .clk(clk),
        .rst(rst),
        .tick(w_msec_tick),
        .clear(clear),
    ...
    // min
    time_counter #(.TICK_COUNT(60), .BIT_WIDTH(6)) U_time_min_counter (
        .clk(clk),
        .rst(rst),
        .tick(w_sec_tick),
        .clear(clear),
    ...
    // hour
    time_counter #(.TICK_COUNT(24), .BIT_WIDTH(5)) U_time_hour_counter (
        .clk(clk),
        .rst(rst),
        .tick(w_min_tick),
        .clear(clear),
