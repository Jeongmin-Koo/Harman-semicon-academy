...
module filter (
    ...
    logic [11:0] rgb444_prev;
    assign rgb444_prev = prev_pixel[15:4];

    assign r_prev = {rgb444_prev[11:8], 1'b0};
    assign g_prev = {rgb444_prev[7:4], 2'b00};
    assign b_prev = {rgb444_prev[3:0], 1'b0}; 


    assign r_blend = (r_curr + r_prev) >> 1;
    assign g_blend = (g_curr + g_prev) >> 1;
    assign b_blend = (b_curr + b_prev) >> 1;
    ...
    always_comb begin : filter_logic
        case (sw)
            ...
            default: begin
                ...
                if (g_curr > 40 && r_curr < 20 && b_curr < 20) begin
                    filteredData = 16'hffff;
                end else begin
