...
module fnd_controller (
    ...
    wire [3:0] w_digit1_temp, w_digit10_temp, w_digit1_humid, w_digit10_humid;
    wire [3:0] w_bcd;
    wire [1:0] w_seg_sel;
    wire w_clk_100hz;
    ...
    digit_splitter U_digit_splitter_temp(
        .bcd(temp),
        .digit_1(w_digit1_temp),
        .digit_10(w_digit10_temp)
    );

    digit_splitter U_digit_splitter_humid(
        .bcd(humid),
        .digit_1(w_digit1_humid),
        .digit_10(w_digit10_humid)
    );
    ...
    .digit_1(w_digit1_temp),
    .digit_10(w_digit10_temp),
    .digit_100(w_digit1_humid),
    .digit_1000(w_digit10_humid),
    .bcd(w_bcd)
);
