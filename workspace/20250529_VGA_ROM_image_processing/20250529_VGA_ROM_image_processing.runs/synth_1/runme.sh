...
HD_PWD='C:/FPGA_Harman_25_1/20250529_VGA_ROM_image_processing/20250529_VGA_ROM_image_processing.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log imageVGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source imageVGA.tcl
