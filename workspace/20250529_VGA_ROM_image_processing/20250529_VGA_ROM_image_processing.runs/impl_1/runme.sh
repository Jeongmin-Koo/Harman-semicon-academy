...
HD_PWD='C:/FPGA_Harman_25_1/20250529_VGA_ROM_image_processing/20250529_VGA_ROM_image_processing.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log imageVGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source imageVGA.tcl -notrace
