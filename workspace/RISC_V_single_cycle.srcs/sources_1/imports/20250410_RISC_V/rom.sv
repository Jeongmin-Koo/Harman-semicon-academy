...
module rom (
    ...
    initial begin
        ...
        rom[7] = 32'b0000_0000_0000_0000_0001_01001_0110111; // LUI x9, 1<<12
        //rom[x]=32'b imm20                  _ rd _ opcode; // AU-Type
        rom[8] = 32'b0000_0000_0000_0000_0001_01010_0010111; // AUIPC x10, PC+1<<12
        //rom[x]=32'b imm20                  _ rd _ opcode; // J-Type
        rom[9] = 32'b0000_0000_1000_0000_0000_01111_1101111; // JAL rd(15) imm(8)
        //rom[x]=32'b imm12        _ rs1 _000_ rd _ opcode; // JL-Type
        rom[11] = 32'b0000_0000_0100_00110_000_10010_1100111; // JALR rd(18) x6(4) imm(4)
    end
