...
module DataPath (
    ...
    logic [31:0]
        ...
        PC_4_AdderResult,
        PCSrcMuxOut,
        PC_ShImm_AdderResult,
        Rs1_Imm_AdderResult;

    assign instrMemAddr = PCOutData;
    assign dataAddr = aluResult;
    assign dataWData = RFData2;
    assign PCSrcMuxSel  = ((btaken & branch)|jump)? 2'b01:
                            (jump_link)? 2'b10 : 2'b00;
    ...
    adder U_Rs1_Imm_Adder (
        .a(RFData1),
        .b(immExt),
        .y(Rs1_Imm_AdderResult)
    );
