...
HD_PWD='C:/0801_cctv/0726_project/20250716_ov5640/hw.runs/system_linearstrech_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_linearstrech_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_linearstrech_0_4.tcl
