...
# set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports sw_0]; #IO_L4N_T0_34 Sch=sw[2]
# set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports sw_1]; #IO_L9P_T1_DQS_34 Sch=sw[3]


#Buttons
# set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports btnU ]; #IO_L12N_T1_MRCC_35 Sch=btn[0]
# set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports btnD ]; #IO_L24N_T3_34 Sch=btn[1]
# set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVCMOS33 } [get_ports btnL ]; #IO_L10P_T1_AD11P_35 Sch=btn[2]
# set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports btnR ]; #IO_L7P_T1_34 Sch=btn[3]
...
##Pmod Heade
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports joy_x]; #IO_L21P_T3_DQS_AD14P_35 Sch=JA1_R_p //vaux14
set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports joy_y]; #IO_L22P_T3_AD7P_35 Sch=JA2_R_P //vaux7
...
##Pmod Header JC
# set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33     } [get_ports { census }]; #IO_L10P_T1_34 Sch=jc_p[1]
...
##Pmod Header JE
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { census }]; #IO_L4P_T0_34 Sch=je[1]
