$repoPath = "C:\Users\kccistc\Documents\GitHub\Harman-semicon-academy"  # 깃허브 레포지토리 클론 폴더 경로를를 지정하면 됩니당.
...
$vivadoWorkspace = "C:\FPGA_Harman_25_1" # Vivado 프로젝트 경로를 지정하면 됩니당.
$gitWorkspace = "$repoPath\workspace"  # 깃허브 레포지토리에 어떤 폴더에 저장할 지 적으면 됩니당.
